...
\clearpage
\section{Discussion}
Factors affecting pollution levels is undoubtedly complex. This discussion focuses on factors that affect NO2; O3; SO2; and CO daily and annually in the context of the graphs in the previous sections. The following summarises the main sources of NO2; O3; SO2; and CO pollution [@epa2016]:
\newline 
 
Pollutant  | Source  |
|:----------|:-------|
NO2 | Vehicle emissions |
O3 | NO2 in presence of sunlight |
SO2 | Electricity production and industrial processes |
CO | Vehicle and gas heating emissions |

The graphs in the previous sections are consistent with: \newline
A *rush hour* pattern of NO2 and CO (emitted from vehicles) as evidenced by the lower probability of peak pollutant levels during working hours. \newline
Inverse proportionality between NO2 and O3 as evidenced by the opposing annual pattern of daily mean pollutant level; and daily patterns of peak pollutant level. \newline
Direct proportionality between sunlight and O3 as evidenced by higher mean daily levels during the summer; and greater probability of peak levels during daylight hours year-round. \newline
...
\section{Conclusion}
The subset of EPA data analysed in this report shows pollutant levels that are consistent with daily and seasonal patterns of sunlight and human behaviour when analysed graphically. 
